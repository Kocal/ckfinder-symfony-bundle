 ...
 */
namespace _CKFinder_Vendor_Prefix\Composer;

use _CKFinder_Vendor_Prefix\Composer\Autoload\ClassLoader;
use _CKFinder_Vendor_Prefix\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_CKFinder_Vendor_Prefix\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
