...
namespace _CKFinder_Vendor_Prefix\spec\League\Flysystem\Cached;

use _CKFinder_Vendor_Prefix\League\Flysystem\AdapterInterface;
use _CKFinder_Vendor_Prefix\League\Flysystem\Cached\CacheInterface;
use _CKFinder_Vendor_Prefix\League\Flysystem\Config;
use _CKFinder_Vendor_Prefix\PhpSpec\ObjectBehavior;
class CachedAdapterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('_CKFinder_Vendor_Prefix\\League\\Flysystem\\Cached\\CachedAdapter');
        $this->shouldHaveType('_CKFinder_Vendor_Prefix\\League\\Flysystem\\AdapterInterface');
    }
