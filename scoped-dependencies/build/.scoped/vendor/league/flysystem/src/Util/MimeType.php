...
namespace _CKFinder_Vendor_Prefix\League\Flysystem\Util;

use _CKFinder_Vendor_Prefix\League\MimeTypeDetection\FinfoMimeTypeDetector;
use _CKFinder_Vendor_Prefix\League\MimeTypeDetection\GeneratedExtensionToMimeTypeMap;
use _CKFinder_Vendor_Prefix\League\MimeTypeDetection\MimeTypeDetector;
/**
 * @internal
 */
class MimeType
