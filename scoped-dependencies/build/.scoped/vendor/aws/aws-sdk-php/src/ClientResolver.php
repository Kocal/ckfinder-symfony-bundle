...
use _CKFinder_Vendor_Prefix\Aws\Api\Validator;
use _CKFinder_Vendor_Prefix\Aws\Api\ApiProvider;
use _CKFinder_Vendor_Prefix\Aws\Api\Service;
use _CKFinder_Vendor_Prefix\Aws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use _CKFinder_Vendor_Prefix\Aws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use _CKFinder_Vendor_Prefix\Aws\ClientSideMonitoring\Configuration;
...
use _CKFinder_Vendor_Prefix\Aws\Endpoint\UseFipsEndpoint\Configuration as UseFipsEndpointConfiguration;
use _CKFinder_Vendor_Prefix\Aws\Endpoint\UseFipsEndpoint\ConfigurationProvider as UseFipsConfigProvider;
use _CKFinder_Vendor_Prefix\Aws\Endpoint\UseFipsEndpoint\ConfigurationInterface as UseFipsEndpointConfigurationInterface;
use _CKFinder_Vendor_Prefix\Aws\Endpoint\UseDualstackEndpoint\Configuration as UseDualStackEndpointConfiguration;
use _CKFinder_Vendor_Prefix\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider as UseDualStackConfigProvider;
use _CKFinder_Vendor_Prefix\Aws\Endpoint\UseDualstackEndpoint\ConfigurationInterface as UseDualStackEndpointConfigurationInterface;
use _CKFinder_Vendor_Prefix\Aws\EndpointDiscovery\ConfigurationInterface;
use _CKFinder_Vendor_Prefix\Aws\EndpointDiscovery\ConfigurationProvider;
use _CKFinder_Vendor_Prefix\Aws\Exception\InvalidRegionException;
use _CKFinder_Vendor_Prefix\Aws\Retry\ConfigurationInterface as RetryConfigInterface;
use _CKFinder_Vendor_Prefix\Aws\Retry\ConfigurationProvider as RetryConfigProvider;
use _CKFinder_Vendor_Prefix\Aws\DefaultsMode\ConfigurationInterface as ConfigModeInterface;
use _CKFinder_Vendor_Prefix\Aws\DefaultsMode\ConfigurationProvider as ConfigModeProvider;
use _CKFinder_Vendor_Prefix\Aws\Signature\SignatureProvider;
use _CKFinder_Vendor_Prefix\Aws\Endpoint\EndpointProvider;
use _CKFinder_Vendor_Prefix\GuzzleHttp\Promise\PromiseInterface;
use _CKFinder_Vendor_Prefix\Aws\Credentials\CredentialProvider;
...
class ClientResolver
{
    ...
    {
        if ($value === \false) {
            $value = new Configuration(\false, \_CKFinder_Vendor_Prefix\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST, \_CKFinder_Vendor_Prefix\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT, \_CKFinder_Vendor_Prefix\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID);
            $args['csm'] = $value;
        }
    ...
    public static function _apply_endpoint_provider(callable $value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            ...
            $args['region'] = \_CKFinder_Vendor_Prefix\Aws\strip_fips_pseudo_regions($args['region']);
