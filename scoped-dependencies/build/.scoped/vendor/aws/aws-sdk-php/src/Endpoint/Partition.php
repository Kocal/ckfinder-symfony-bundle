...
use ArrayAccess;
use _CKFinder_Vendor_Prefix\Aws\HasDataTrait;
use _CKFinder_Vendor_Prefix\Aws\Sts\RegionalEndpoints\ConfigurationProvider;
use _CKFinder_Vendor_Prefix\Aws\S3\RegionalEndpoint\ConfigurationProvider as S3ConfigurationProvider;
