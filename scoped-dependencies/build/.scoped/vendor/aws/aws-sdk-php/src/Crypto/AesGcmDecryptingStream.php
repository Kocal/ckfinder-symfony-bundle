...
use _CKFinder_Vendor_Prefix\GuzzleHttp\Psr7\StreamDecoratorTrait;
use _CKFinder_Vendor_Prefix\Psr\Http\Message\StreamInterface;
use _CKFinder_Vendor_Prefix\Aws\Crypto\Polyfill\AesGcm;
use _CKFinder_Vendor_Prefix\Aws\Crypto\Polyfill\Key;
/**
