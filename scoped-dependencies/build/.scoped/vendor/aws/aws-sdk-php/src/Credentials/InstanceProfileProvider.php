...
use _CKFinder_Vendor_Prefix\Aws\Exception\InvalidJsonException;
use _CKFinder_Vendor_Prefix\Aws\Sdk;
use _CKFinder_Vendor_Prefix\GuzzleHttp\Exception\TransferException;
...
class InstanceProfileProvider
{
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \_CKFinder_Vendor_Prefix\Aws\default_user_agent();
