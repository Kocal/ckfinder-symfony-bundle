...
use _CKFinder_Vendor_Prefix\Aws\Retry\ConfigurationInterface;
use _CKFinder_Vendor_Prefix\Aws\Retry\QuotaManager;
use _CKFinder_Vendor_Prefix\Aws\Retry\RateLimiter;
use _CKFinder_Vendor_Prefix\Aws\Retry\RetryHelperTrait;
