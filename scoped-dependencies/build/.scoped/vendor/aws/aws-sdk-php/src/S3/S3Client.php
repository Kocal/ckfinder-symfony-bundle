...
use _CKFinder_Vendor_Prefix\Aws\Command;
use _CKFinder_Vendor_Prefix\Aws\Exception\AwsException;
use _CKFinder_Vendor_Prefix\Aws\HandlerList;
use _CKFinder_Vendor_Prefix\Aws\InputValidationMiddleware;
use _CKFinder_Vendor_Prefix\Aws\Middleware;
use _CKFinder_Vendor_Prefix\Aws\Retry\QuotaManager;
...
use _CKFinder_Vendor_Prefix\Aws\S3\RegionalEndpoint\ConfigurationProvider;
use _CKFinder_Vendor_Prefix\GuzzleHttp\Exception\RequestException;
use _CKFinder_Vendor_Prefix\GuzzleHttp\Promise\Promise;
...
class S3Client extends AwsClient implements S3ClientInterface
{
    ...
    public function createPresignedRequest(CommandInterface $command, $expires, array $options = [])
    {
        ...
        return $signer->presign(\_CKFinder_Vendor_Prefix\Aws\serialize($command), $this->getCredentials()->wait(), $expires, $options);
    }
    /**
    ...
    public function getObjectUrl($bucket, $key)
    {
        ...
        return (string) \_CKFinder_Vendor_Prefix\Aws\serialize($command)->getUri();
    }
    /**
