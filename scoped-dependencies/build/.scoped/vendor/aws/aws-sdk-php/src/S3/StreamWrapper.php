...
use _CKFinder_Vendor_Prefix\GuzzleHttp\Psr7\Stream;
use _CKFinder_Vendor_Prefix\GuzzleHttp\Psr7\CachingStream;
...
class StreamWrapper
{
    ...
    public function dir_opendir($path, $options)
    {
        ...
        $this->objectIterator = \_CKFinder_Vendor_Prefix\Aws\flatmap($this->getClient()->getPaginator('ListObjects', $op), function (Result $result) use($filterFn) {
