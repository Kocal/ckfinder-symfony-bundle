...
use _CKFinder_Vendor_Prefix\GuzzleHttp\Cookie\CookieJar;
use _CKFinder_Vendor_Prefix\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \_CKFinder_Vendor_Prefix\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
