...
namespace _CKFinder_Vendor_Prefix\GuzzleHttp\Handler;
...
use _CKFinder_Vendor_Prefix\GuzzleHttp\Promise as P;
use _CKFinder_Vendor_Prefix\GuzzleHttp\Promise\FulfilledPromise;
use _CKFinder_Vendor_Prefix\GuzzleHttp\Promise\PromiseInterface;
use _CKFinder_Vendor_Prefix\GuzzleHttp\Psr7\LazyOpenStream;
use _CKFinder_Vendor_Prefix\GuzzleHttp\TransferStats;
use _CKFinder_Vendor_Prefix\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \_CKFinder_Vendor_Prefix\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \_CKFinder_Vendor_Prefix\GuzzleHttp\Psr7\Utils::streamFor($sink);
