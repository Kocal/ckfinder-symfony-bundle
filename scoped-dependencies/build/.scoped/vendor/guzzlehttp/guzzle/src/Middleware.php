...
use _CKFinder_Vendor_Prefix\GuzzleHttp\Cookie\CookieJarInterface;
...
use _CKFinder_Vendor_Prefix\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('_CKFinder_Vendor_Prefix\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
