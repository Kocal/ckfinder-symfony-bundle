...
namespace _CKFinder_Vendor_Prefix\GuzzleHttp\Exception;

use _CKFinder_Vendor_Prefix\GuzzleHttp\BodySummarizer;
use _CKFinder_Vendor_Prefix\GuzzleHttp\BodySummarizerInterface;
use _CKFinder_Vendor_Prefix\Psr\Http\Client\RequestExceptionInterface;
